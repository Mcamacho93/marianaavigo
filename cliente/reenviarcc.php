...
if($_SESSION['verified'] == 'y'){
    ...
    $query = "select * from clients where clientCode = ".$idcte."";
    $queryexe = $bd->query($query);
    $colcte = $bd->fassoc($queryexe);
    $idhash = hash('sha256', $idcte);
    $emailhash = hash('sha256', $colcte['clientEmail']);
    $correo -> charSet = "UTF-8";
    $correo->addAddress($colcte['clientEmail'], 'Casa Laietana');
            ...
            <body>
               <div class="container">
                  ...
                  <div class="link">
                     ...
                     <a href="http://www.lomas.mx/casalaietana/cliente/verificarcta.php?tid='.$idhash.'&temp='.$emailhash.'">COMPLETAR REGISTRO</a>
